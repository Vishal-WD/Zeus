"""
Zeus Central Core Engine — National EV Grid Network Optimizer
Implements M/D/c queue modeling, multi-objective anti-herd cost function,
Haversine geolocation routing, and dynamic dock ranking across all India.
"""
...
# ── Major National Highway and Metropolitan Reference Nodes Across India ──

NATIONAL_LANDMARKS: Dict[str, Dict[str, Any]] = {
    "delhi_aerocity": {"name": "Delhi IGI Aerocity Gateway", "coords": [77.1215, 28.5501], "type": "transit"},
    "mumbai_bkc": {"name": "Mumbai BKC Financial Center", "coords": [72.8687, 19.0657], "type": "commercial"},
    "bengaluru_ecity": {"name": "Bengaluru Electronic City", "coords": [77.6648, 12.8452], "type": "tech_park"},
    "chennai_omr": {"name": "Chennai OMR IT Corridor", "coords": [80.2337, 12.9348], "type": "tech_park"},
    "hyderabad_hitec": {"name": "Hyderabad Hitec City", "coords": [78.3498, 17.4156], "type": "tech_park"},
    "pune_expressway": {"name": "Mumbai-Pune Expressway Plaza", "coords": [73.6642, 18.7321], "type": "highway"},
    "kolkata_sector_v": {"name": "Kolkata Salt Lake Sector V", "coords": [88.4328, 22.5804], "type": "tech_park"},
    "ahmedabad_sg": {"name": "Ahmedabad SG Highway", "coords": [72.5085, 23.0286], "type": "commercial"},
    "kochi_infopark": {"name": "Kochi Infopark Expressway", "coords": [76.3572, 10.0124], "type": "tech_park"},
    "jaipur_nh48": {"name": "Jaipur NH-48 Highway Interchange", "coords": [75.8924, 27.0289], "type": "highway"},
}

# Backward compatibility alias
MADURAI_LANDMARKS = NATIONAL_LANDMARKS
